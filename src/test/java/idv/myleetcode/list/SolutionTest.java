...
public class SolutionTest {
    ...
    public void test2_1(){
        ...
        m1.next = m2;
        m2.next = m3;
        ListNode h = s.addTwoNumberInorder(n1, m1);
        int[] r = new int[3];
        int i=0;
        while(h!=null){
            r[i++] = h.val;
        ...
        assertEquals("[8, 0, 7]", Arrays.toString(r));
		ListNode p = new ListNode(9);
		h = s.addTwoNumberInorder(n1, p);
		r = new int[3];
        i=0;
        while(h!=null){
            r[i++] = h.val;
        ...
        assertEquals("[2, 5, 2]", Arrays.toString(r));
		p = new ListNode(9);
        ...
        assertEquals("[1, 0, 0, 0, 0]", Arrays.toString(r));
    }
